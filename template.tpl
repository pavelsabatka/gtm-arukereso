...
{
  "displayName": "Arukereso - Development",
  "categories": [
    "ANALYTICS",
    "ADVERTISING"
  ],
  ...
  "version": 1,
  "brand": {
    "thumbnail": "data:image/png;base64,\u003d",
...
[
  ...
  },
  {
    ...
    "clearOnCopy": true,
    "help": "Conversion code key from Arukereso administration",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
  ...
  },
  {
    ...
    "help": "Object of Transaction in GA4 format. If submitted, ID, currency, products and some additional items will be loaded automatically.",
    "notSetText": "Not set",
    "alwaysInSummary": true
  },
  {
  ...
  },
  {
    ...
    "help": "If enabled, shipping, payment and voucher will be automatically added as additional items from the transaction object"
  }
]
...
let add_data = () => {};
let url = 'https://www.arukereso.hu/ocm/sdk.js?version=2&page='+data.code_type;


log('ARUKERESO '+data.code_type+': starting code with', data);
...
if (data.code_type === 'thank_you') {
  add_data = function() {
    log('ARUKERESO '+data.code_type+': adding data');
	arukereso('authenticate', data.id);
    ...
    if (order_id) {
      arukereso('set_order_id', makeString(order_id));
      log(' - set_order_id', order_id);
    } else {
      log('ARUKERESO ERROR: INVALID_ORDER_ID, got value', order_id);
    ...
    if (getType(products) !== 'array') {
      log("ARUKERESO CONVERSION: passing non-array value", products);
      products = [];
    }
    ...
    for (let i = 0; i < products.length; i++) {
      ...
      if (id === '') {
        log('ARUKERESO ERROR: MISSING_ITEM_ID, item '+name+' has invalid price', id);
      }
      if (price < 0) {
        log('ARUKERESO ERROR: INVALID_ITEM_PRICE, item '+name+' has invalid price', price);
      }
      if (quantity < 0) {
        log('ARUKERESO ERROR: INVALID_ITEM_QUANTITY, item '+name+' has invalid quantity', quantity);
      }
    ...
    for (let i = 0; i < preparedProducts.length; i++) {
      ...
      arukereso('add_product', item.id, item.name, floatToString(item.price), makeString(item.quantity));
    ...
    for (let i = 0; i < additionalItems.length; i++) {
      ...
      arukereso('add_additional_item', item.name, floatToString(price), makeString(quantity));
    ...
    arukereso('set_total_vat', totalRevenue);
    ...
    if (totalRevenue != floatToString(revenue)) {
      log('ARUKERESO ERROR: PRICE_DONT_MATCH, calculated price is', totalRevenue, ', order price from data is', revenue);
    }
    ...
    if (!currency || currency === '') {
        log('ARUKERESO ERROR: MISSING_CURRENCY, get currency code', currency);
    } else if (currency.length !== 3) {
      log('ARUKERESO ERROR: INVALID_CURRENCY, get currency code', currency);
    } else {
      arukereso('set_currency', currency);
...
if (!error) {
  injectScript(url, () => {
    log('ARUKERESO '+data.code_type+': success', data);
    data.gtmOnSuccess();
  }, () => {
    log('ARUKERESO '+data.code_type+': script loading failed', data);
    data.gtmOnFailure();
  });
} else {
  log('ARUKERESO '+data.code_type+': script was not loaded due to faltal error in data');
  data.gtmOnFailure();
}
...
- name: Purchase - from transaction object - with additional items
  code: |-
    ...
    mockDataObject.order.value = 76.54;
    ...
    assertThat(passedData[5]).isEqualTo(['add_additional_item', 'payment', '1.50', '1']);
    assertThat(passedData[6]).isEqualTo(['add_additional_item', 'voucher', '-3.00', '1']);

    assertThat(passedData[7]).isEqualTo(['set_total_vat', '76.54']);
- name: Purchase - from transaction object - with invalid additional items
  code: |-
    mockDataObject.load_additional_items_from_object = true;
    mockDataObject.order.value = 75.04;
    ...
    assertThat(passedData[4]).isEqualTo(['add_additional_item', 'shipping', '5.99', '1']);
    assertThat(passedData[5]).isEqualTo(['add_additional_item', 'voucher', '-3.00', '1']);

    assertThat(passedData[6]).isEqualTo(['set_total_vat', '75.04']);
...
setup: |-
  ...
  let expected_url = 'https://www.arukereso.hu/ocm/sdk.js?version=2&page=thank_you';
